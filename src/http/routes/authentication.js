...
routes.post("/refresh-token",validatorBody(authSchema.refreshToken),authorized(REFRESH_TOKEN,allRoleValue),authEndpoint.refreshTokenEndpoint)
routes.post("/log-out",validatorBody(authSchema.refreshToken),authorized(REFRESH_TOKEN,allRoleValue),authEndpoint.logOutEndpoint)
